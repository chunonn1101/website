...
export const products = [
  ...
  {
    id: "p25", slug: "saint-l-tuxedo-blazer-black", brand: "Saint L",
    name: "Tuxedo Blazer", category: "clothing", gender: "women", price: 5600,
    condition: "Excellent", colour: "Black", material: "Wool and satin", year: 2022,
    description: "A sharply tailored double-breasted blazer with a clean satin finish and beautifully preserved structure.",
    includedItems: ["Garment bag", "Spare button"], images: [img("clothing-black-blazer")],
    featured: true, newArrival: true, verified: true,
  },
  {
    id: "p26", slug: "dio-draped-silk-midi-dress-ivory", brand: "Dio",
    name: "Draped Silk Midi Dress", category: "clothing", gender: "women", price: 6900,
    condition: "Pristine", colour: "Ivory", material: "Silk crepe", year: 2023,
    description: "A fluid ivory midi dress with an elegant draped neckline, lustrous finish and immaculate seams.",
    includedItems: ["Garment bag"], images: [img("clothing-ivory-silk-dress")],
    featured: true, newArrival: true, verified: true,
  },
  {
    id: "p27", slug: "burber-belted-wool-coat-camel", brand: "Burber",
    name: "Belted Wool Coat", category: "clothing", gender: "women", price: 7200,
    condition: "Excellent", colour: "Camel", material: "Wool", year: 2021,
    description: "A timeless full-length camel coat with a softly brushed finish, precise lapels and a removable belt.",
    includedItems: ["Garment bag", "Belt"], images: [img("clothing-camel-wool-coat")],
    featured: true, newArrival: true, verified: true,
  },
  {
    id: "p28", slug: "bottega-v-sculpted-leather-jacket-oxblood", brand: "Bottega V",
    name: "Sculpted Leather Jacket", category: "clothing", gender: "women", price: 9800,
    condition: "Very Good", colour: "Oxblood", material: "Calfskin leather", year: 2020,
    description: "A sculptural oxblood leather jacket with a defined waist, supple hand and light, even signs of careful wear.",
    includedItems: ["Garment bag"], images: [img("clothing-oxblood-leather-jacket")],
    featured: true, newArrival: true, verified: true,
  },
  {
    id: "p29", slug: "celi-essential-oversized-tshirt-white", brand: "Celi",
    name: "Essential Oversized T-Shirt", category: "clothing", gender: "men", price: 1350,
    condition: "Excellent", colour: "White", material: "Heavyweight cotton", year: 2023,
    description: "A crisp oversized crew-neck T-shirt in substantial cotton jersey with a clean neckline and minimal signs of wear.",
    includedItems: ["Garment sleeve"], images: [img("clothing-white-oversized-tshirt")],
    featured: false, newArrival: true, verified: true,
  },
  {
    id: "p30", slug: "saint-l-ribbed-fitted-tshirt-black", brand: "Saint L",
    name: "Ribbed Fitted T-Shirt", category: "clothing", gender: "women", price: 1850,
    condition: "Pristine", colour: "Black", material: "Ribbed cotton jersey", year: 2024,
    description: "A refined fitted T-shirt with fine ribbing, a precise crew neck and an immaculate tonal finish.",
    includedItems: ["Garment sleeve"], images: [img("clothing-black-ribbed-tshirt")],
    featured: false, newArrival: true, verified: true,
  },
  {
    id: "p31", slug: "bottega-v-relaxed-cotton-tshirt-oxblood", brand: "Bottega V",
    name: "Relaxed Cotton T-Shirt", category: "clothing", gender: "men", price: 2100,
    condition: "Very Good", colour: "Oxblood", material: "Cotton jersey", year: 2022,
    description: "A relaxed heavyweight T-shirt in a deep oxblood tone with a soft hand and even, carefully maintained colour.",
    includedItems: ["Garment sleeve"], images: [img("clothing-oxblood-relaxed-tshirt")],
    featured: false, newArrival: true, verified: true,
  },
  {
    id: "p32", slug: "gucc-striped-knit-tshirt-ivory-navy", brand: "Gucc",
    name: "Striped Knit T-Shirt", category: "clothing", gender: "women", price: 1950,
    condition: "Excellent", colour: "Ivory / Navy", material: "Cotton knit", year: 2021,
    description: "A polished short-sleeve knit T-shirt with balanced navy stripes, crisp ribbing and excellent shape retention.",
    includedItems: ["Garment sleeve"], images: [img("clothing-striped-knit-tshirt")],
    featured: false, newArrival: true, verified: true,
  },
];
